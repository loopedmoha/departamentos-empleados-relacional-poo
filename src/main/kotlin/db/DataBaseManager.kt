...
object DataBaseManager {
    ...
    */
    ...
    private fun initConfig() {
        ...
        user = "blog"
        password = "blog1234"
        // dirección al fichero de inicialización de la base de datos, con las tablas y datos
        initScript = System.getProperty("user.dir") + File.separator + "db" + File.separator + "init.sql"
